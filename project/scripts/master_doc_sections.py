"""Narrative section generators for MASTER document (architecture-focused v2)."""
...
def part1_ch2_experiment_design() -> str:
    return """
## 第2章 实验设计思路与演进
...
def part2_ch6_data_training() -> str:
    return """
## 第6章 数据与训练流程
...
def part4_ch9_agent_overview() -> str:
    return """
...
def build_all(r4_phase_tables: str, champ_table: str, metrics_table: str) -> str:
    """Assemble full narrative document body."""
    parts = [
        part1_ch1_literature(),
        part1_ch2_experiment_design(),
        part2_ch3_overall(),
        part2_ch4_encoders(),
        part2_ch5_fusion(),
        part2_ch6_data_training(),
        part3_ch7_analysis(),
        champ_table.strip(),
        metrics_table.strip(),
        "\n### 7.6 分 Phase 详表（build_sdavt_r4_report）\n",
        r4_phase_tables.strip(),
        part3_ch8_fixes(),
        part4_ch9_agent_overview(),
        part4_ch10_frontend(),
        part4_ch11_backend(),
        part4_ch12_chinese(),
        appendix_a_scripts(),
