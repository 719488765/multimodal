...
| p3_m3 | P3-M MELD Tier-2 | 8 | 1 | 0 | 7 |
| p3_c3 | P3-C CREMA Tier-2 | 3 | 0 | 1 | 2 |
...
| Phase | Job | Best F1 | Target F1 | Best Acc | Target Acc | Tier-2 |
|-------|-----|---------|-----------|----------|------------|--------|
| p3_c3 | C3_C1_baseline | — | — | — | 0.6300 | △ |
| p3_c3 | C3_C2_w2v_large | — | — | — | 0.6300 | △ |
| p3_c3 | C3_C3_focal | — | — | — | 0.6300 | △ |

### 任务明细

| Job | Dataset | Fusion | Status | Best Acc@ep | Best F1@ep | Epochs | Run |
|-----|---------|--------|--------|-------------|------------|--------|-----|
| C3_C1_baseline | crema | emotion_shift | running | — @ — | — @ — | — | `—` |
| C3_C2_w2v_large | crema | emotion_shift | pending | — @ — | — @ — | — | `—` |
| C3_C3_focal | crema | emotion_shift | pending | — @ — | — @ — | — | `—` |
