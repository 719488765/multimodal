...
| p2_fusion | P2 融合策略消融 | 14 | 13 | 1 | 0 |
| p3_m3 | P3-M MELD Tier-2 | 8 | 0 | 0 | 8 |
| p3_c3 | P3-C CREMA Tier-2 | 0 | 0 | 0 | 0 |
| p4_modal | P4 模态消融 | 7 | 0 | 0 | 7 |
...
|---------|--------|--------|------------|-------------|-----|
| meld | F_M_LFA | leader_follower | 0.4562 @ 3 | 0.4937 @ 1 | `SDAVT_R4_F_M_LFA_20260623_210443` |
| crema | F_C_ES | emotion_shift | 0.5786 @ 28 | 0.5860 @ 28 | `SDAVT_R4_F_C_ES_20260624_060621` |
...
| Job | Dataset | Fusion | Status | Best Acc@ep | Best F1@ep | Epochs | Run |
|-----|---------|--------|--------|-------------|------------|--------|-----|
| F_C_ES | crema | emotion_shift | done | 0.5860 @ 28 | 0.5786 @ 28 | 41 | `SDAVT_R4_F_C_ES_20260624_060621` |
...
| F_M_ES | meld | emotion_shift | running | 0.6245 @ 3 | 0.6109 @ 3 | 5 | `SDAVT_R4_F_M_ES` |
...
**Tier-2 目标**: MELD F1≥0.59 & Acc≥0.62；CREMA Acc≥0.63。

### Tier-2 达标对照

| Phase | Job | Best F1 | Target F1 | Best Acc | Target Acc | Tier-2 |
|-------|-----|---------|-----------|----------|------------|--------|
| p3_m3 | M3_M0_baseline | — | 0.5900 | — | 0.6200 | △ |
| p3_m3 | M3_M1_roberta | — | 0.5900 | — | 0.6200 | △ |
| p3_m3 | M3_M2_w2v_large | — | 0.5900 | — | 0.6200 | △ |
| p3_m3 | M3_M3_uniform | — | 0.5900 | — | 0.6200 | △ |
| p3_m3 | M3_M4_focal | — | 0.5900 | — | 0.6200 | △ |
| p3_m3 | M3_M5_context | — | 0.5900 | — | 0.6200 | △ |
| p3_m3 | M3_M6_moddrop | — | 0.5900 | — | 0.6200 | △ |
...
| Job | Dataset | Fusion | Status | Best Acc@ep | Best F1@ep | Epochs | Run |
|-----|---------|--------|--------|-------------|------------|--------|-----|
| M3_M0_baseline | meld | emotion_shift | pending | — @ — | — @ — | — | `—` |
| M3_M1_roberta | meld | emotion_shift | pending | — @ — | — @ — | — | `—` |
| M3_M2_w2v_large | meld | emotion_shift | pending | — @ — | — @ — | — | `—` |
| M3_M3_uniform | meld | emotion_shift | pending | — @ — | — @ — | — | `—` |
| M3_M4_focal | meld | emotion_shift | pending | — @ — | — @ — | — | `—` |
| M3_M5_context | meld | emotion_shift | pending | — @ — | — @ — | — | `—` |
| M3_M6_moddrop | meld | emotion_shift | pending | — @ — | — @ — | — | `—` |
| M3_M7_combo | meld | emotion_shift | pending | — @ — | — @ — | — | `—` |
...
| p2_fusion | F_C_ES | `SDAVT_R4_F_C_ES_20260624_060621` | ✓ | `logs_sdavt_v3_r4/SDAVT_R4_F_C_ES_20260624_060621/metrics.csv` | [`fig`](outputs_sdavt_v3_r4/figures/SDAVT_R4_F_C_ES_20260624_060621_curves.png) |
