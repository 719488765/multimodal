...
| F_O_LFT | mosei | done | 0.5980 @ 7 | 0.7162 | — | ✗ dup | ✓ | `SDAVT_R4_F_O_LFT_20260622_214330` |
| F_O_STD | mosei | done | 0.5988 @ 7 | 0.7162 | — | ✗ dup | ✓ | `SDAVT_R4_F_O_STD_20260622_222125` |
| F_O_TS | mosei | done | 0.5978 @ 0 | 0.7162 | — | ✗ dup | ✓ | `SDAVT_R4_F_O_TS_20260622_232044` |
...
| R4_B_O0 | mosei | done | 0.6792 @ 12 | 0.7269 | — | ✗ dup | ✓ | `SDAVT_R4_R4_B_O0_20260623_032138` |

## p2_fusion

| Job | Dataset | Status | Best F1@ep | Best Acc@ep | Collapse | Dup | Tier-2 | Run |
|-----|---------|--------|------------|-------------|----------|-----|--------|-----|
| F_C_ES | crema | done | 0.3263 @ 36 | 0.3575 | — | ✗ dup | ✓ | `SDAVT_R4_F_C_ES` |
...
| F_O_ES | mosei | done | 0.6792 @ 12 | 0.7269 | — | ✗ dup | ✓ | `SDAVT_R4_F_O_ES_20260624_101647` |
| F_O_LFT | mosei | done | 0.5980 @ 7 | 0.7162 | — | ✗ dup | ✓ | `SDAVT_R4_F_O_LFT_20260624_110504` |
| F_O_STD | mosei | done | 0.5988 @ 7 | 0.7162 | — | ✗ dup | ✓ | `SDAVT_R4_F_O_STD_20260624_115119` |
| F_O_TS | mosei | done | 0.5978 @ 0 | 0.7162 | — | ✗ dup | ✓ | `SDAVT_R4_F_O_TS_20260624_123518` |
...
| Job | Dataset | Status | Best F1@ep | Best Acc@ep | Collapse | Dup | Tier-2 | Run |
|-----|---------|--------|------------|-------------|----------|-----|--------|-----|
| M3_M0_baseline | meld | done | 0.6080 @ 3 | 0.6218 | — | ✗ dup | ✓ | `SDAVT_R4_M3_M0_baseline_20260625_200937` |
...
| M3_M3_uniform | meld | done | 0.6105 @ 3 | 0.6245 | — | ✗ dup | ✓ | `SDAVT_R4_M3_M3_uniform_20260626_031222` |
| M3_M4_focal | meld | done | 0.6079 @ 3 | 0.6209 | — | ✗ dup | ✓ | `SDAVT_R4_M3_M4_focal_20260626_062916` |
...
| R4_A_C_AVT | crema | done | 0.3263 @ 36 | 0.3575 | ✓ | ✗ dup | ✓ | `SDAVT_R4_R4_A_C_AVT` |
...
| R4_A_M_AT | meld | pending | — @ — | — | — | — | △ | `—` |
| R4_A_M_AV | meld | pending | — @ — | — | — | — | △ | `—` |
| R4_A_M_AVT | meld | pending | — @ — | — | — | — | △ | `—` |
| R4_A_M_T | meld | pending | — @ — | — | — | — | △ | `—` |
| R4_A_M_V | meld | running | 0.2518 @ 0 | 0.4233 | ✓ | — | ✓ | `SDAVT_R4_R4_A_M_V` |
| R4_A_M_VT | meld | pending | — @ — | — | — | — | △ | `—` |
| R4_A_O_A | mosei | done | 0.0881 @ 0 | 0.2330 | ✗ collapse | — | ✗ | `SDAVT_R4_R4_A_O_A` |
| R4_A_O_AT | mosei | done | 0.0881 @ 0 | 0.2330 | ✗ collapse | — | ✗ | `SDAVT_R4_R4_A_O_AT` |
| R4_A_O_AV | mosei | done | 0.0881 @ 0 | 0.2330 | ✗ collapse | — | ✗ | `SDAVT_R4_R4_A_O_AV` |
| R4_A_O_AVT | mosei | done | 0.0881 @ 0 | 0.2330 | ✗ collapse | — | ✗ | `SDAVT_R4_R4_A_O_AVT` |
