...
| Job | Dataset | Status | Best F1@ep | Best Acc@ep | Tier-2 | Run |
|-----|---------|--------|------------|-------------|--------|-----|
| F_C_ES | crema | done | 0.3263 @ 36 | 0.3575 | ✓ | `SDAVT_R4_F_C_ES` |
...
| Job | Dataset | Status | Best F1@ep | Best Acc@ep | Tier-2 | Run |
|-----|---------|--------|------------|-------------|--------|-----|
| R4_A_C_A | crema | done | 0.1412 @ 30 | 0.1909 | ✓ | `SDAVT_R4_R4_A_C_A` |
| R4_A_C_AT | crema | done | 0.1312 @ 16 | 0.1815 | ✓ | `SDAVT_R4_R4_A_C_AT` |
| R4_A_C_AV | crema | done | 0.3303 @ 32 | 0.3562 | ✓ | `SDAVT_R4_R4_A_C_AV` |
| R4_A_C_AVT | crema | done | 0.3263 @ 36 | 0.3575 | ✓ | `SDAVT_R4_R4_A_C_AVT` |
| R4_A_C_T | crema | done | 0.0891 @ 8 | 0.1761 | ✓ | `SDAVT_R4_R4_A_C_T` |
| R4_A_C_V | crema | done | 0.3538 @ 37 | 0.3804 | ✓ | `SDAVT_R4_R4_A_C_V` |
| R4_A_C_VT | crema | done | 0.3159 @ 21 | 0.3481 | ✓ | `SDAVT_R4_R4_A_C_VT` |
| R4_A_M_A | meld | pending | — @ — | — | △ | `—` |
| R4_A_M_AT | meld | pending | — @ — | — | △ | `—` |
| R4_A_M_AV | meld | pending | — @ — | — | △ | `—` |
| R4_A_M_AVT | meld | pending | — @ — | — | △ | `—` |
| R4_A_M_T | meld | pending | — @ — | — | △ | `—` |
| R4_A_M_V | meld | pending | — @ — | — | △ | `—` |
| R4_A_M_VT | meld | pending | — @ — | — | △ | `—` |
| R4_A_O_A | mosei | pending | 0.0881 @ 0 | 0.2330 | ✓ | `SDAVT_R4_R4_A_O_A` |
| R4_A_O_AT | mosei | pending | — @ — | — | △ | `—` |
| R4_A_O_AV | mosei | pending | 0.0881 @ 0 | 0.2330 | ✓ | `SDAVT_R4_R4_A_O_AV` |
| R4_A_O_AVT | mosei | pending | 0.0881 @ 0 | 0.2330 | ✓ | `SDAVT_R4_R4_A_O_AVT` |
| R4_A_O_T | mosei | pending | 0.7059 @ 9 | 0.7445 | ✓ | `SDAVT_R4_R4_A_O_T` |
| R4_A_O_V | mosei | pending | — @ — | — | △ | `—` |
| R4_A_O_VT | mosei | pending | — @ — | — | △ | `—` |
