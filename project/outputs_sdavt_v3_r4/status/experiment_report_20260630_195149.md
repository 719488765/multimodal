...
| Job | Dataset | Status | Best F1@ep | Best Acc@ep | Tier-2 | Run |
|-----|---------|--------|------------|-------------|--------|-----|
| F_C_ES | crema | done | 0.3272 @ 10 | 0.3374 | ✓ | `SDAVT_R4_F_C_ES` |
...
| Job | Dataset | Status | Best F1@ep | Best Acc@ep | Tier-2 | Run |
|-----|---------|--------|------------|-------------|--------|-----|
| R4_A_C_A | crema | pending | 0.3272 @ 10 | 0.3374 | ✓ | `SDAVT_R4_F_C_ES` |
| R4_A_C_AT | crema | failed | 0.3272 @ 10 | 0.3374 | ✓ | `SDAVT_R4_F_C_ES` |
| R4_A_C_AV | crema | pending | 0.3272 @ 10 | 0.3374 | ✓ | `SDAVT_R4_F_C_ES` |
| R4_A_C_AVT | crema | running | 0.3272 @ 10 | 0.3374 | ✓ | `SDAVT_R4_F_C_ES` |
| R4_A_C_T | crema | pending | 0.3272 @ 10 | 0.3374 | ✓ | `SDAVT_R4_F_C_ES` |
| R4_A_C_V | crema | pending | 0.3272 @ 10 | 0.3374 | ✓ | `SDAVT_R4_F_C_ES` |
| R4_A_C_VT | crema | pending | 0.3272 @ 10 | 0.3374 | ✓ | `SDAVT_R4_F_C_ES` |
...
| R4_A_O_A | mosei | done | — @ — | — | △ | `—` |
| R4_A_O_AT | mosei | done | — @ — | — | △ | `—` |
| R4_A_O_AV | mosei | done | — @ — | — | △ | `—` |
| R4_A_O_AVT | mosei | done | — @ — | — | △ | `—` |
| R4_A_O_T | mosei | running | — @ — | — | △ | `—` |
