...
| Job | Dataset | Status | Best F1@ep | Best Acc@ep | Tier-2 | Run |
|-----|---------|--------|------------|-------------|--------|-----|
| R4_A_C_A | crema | pending | — @ — | — | △ | `—` |
| R4_A_C_AT | crema | running | — @ — | — | △ | `SDAVT_R4_R4_A_C_AT` |
| R4_A_C_AV | crema | running | — @ — | — | △ | `SDAVT_R4_R4_A_C_AV` |
| R4_A_C_AVT | crema | failed | — @ — | — | △ | `—` |
| R4_A_C_T | crema | pending | — @ — | — | △ | `—` |
| R4_A_C_V | crema | pending | — @ — | — | △ | `—` |
| R4_A_C_VT | crema | pending | — @ — | — | △ | `—` |
...
| R4_A_O_AT | mosei | running | 0.0881 @ 0 | 0.2330 | ✓ | `SDAVT_R4_R4_A_O_AT` |
