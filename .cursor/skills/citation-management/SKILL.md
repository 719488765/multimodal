...
```bash
python .cursor/skills/citation-management/scripts/generate_schematic.py "your diagram description" -o figures/output.png
```
...
python .cursor/skills/citation-management/scripts/search_google_scholar.py "CRISPR gene editing" \
  --limit 50 \
  --output results.json

# Search with year filter
python .cursor/skills/citation-management/scripts/search_google_scholar.py "machine learning protein folding" \
  --year-start 2020 \
  --year-end 2024 \
  --limit 100 \
...
```bash
# Search PubMed
python .cursor/skills/citation-management/scripts/search_pubmed.py "Alzheimer's disease treatment" \
  --limit 100 \
  --output alzheimers.json

# Search with MeSH terms and filters
python .cursor/skills/citation-management/scripts/search_pubmed.py \
...
```bash
# Convert single DOI
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py 10.1038/s41586-021-03819-2

# Convert multiple DOIs from a file
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py --input dois.txt --output references.bib

# Different output formats
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py 10.1038/nature12345 --format json
```
...
```bash
# Extract from DOI
python .cursor/skills/citation-management/scripts/extract_metadata.py --doi 10.1038/s41586-021-03819-2

# Extract from PMID
python .cursor/skills/citation-management/scripts/extract_metadata.py --pmid 34265844

# Extract from arXiv ID
python .cursor/skills/citation-management/scripts/extract_metadata.py --arxiv 2103.14030

# Extract from URL
python .cursor/skills/citation-management/scripts/extract_metadata.py --url "https://www.nature.com/articles/s41586-021-03819-2"

# Batch extraction from file (mixed identifiers)
python .cursor/skills/citation-management/scripts/extract_metadata.py --input identifiers.txt --output citations.bib
```
...
python .cursor/skills/citation-management/scripts/format_bibtex.py references.bib \
...
python .cursor/skills/citation-management/scripts/validate_citations.py references.bib
...
python .cursor/skills/citation-management/scripts/extract_metadata.py \
  --input crispr_papers.json \
  --output crispr_refs.bib

# 3. Add specific papers by DOI
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py 10.1038/nature12345 >> crispr_refs.bib
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py 10.1126/science.abcd1234 >> crispr_refs.bib

# 4. Format and clean the BibTeX file
python .cursor/skills/citation-management/scripts/format_bibtex.py crispr_refs.bib \
  --deduplicate \
  --sort year \
  --descending \
...
python .cursor/skills/citation-management/scripts/validate_citations.py my_review_references.bib --report review_validation.json

# Format for specific citation style if needed
python .cursor/skills/citation-management/scripts/format_bibtex.py my_review_references.bib \
  --style nature \
...
```bash
# Basic search
python .cursor/skills/citation-management/scripts/search_google_scholar.py "quantum computing"
...
python .cursor/skills/citation-management/scripts/search_google_scholar.py "machine learning" \
  --limit 50 \
  --format bibtex \
...
python .cursor/skills/citation-management/scripts/search_pubmed.py "CRISPR gene editing"
...
# Export to BibTeX
python .cursor/skills/citation-management/scripts/search_pubmed.py "Alzheimer's disease" \
  --limit 100 \
  --format bibtex \
...
# Multiple DOIs
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py \
  10.1038/nature12345 \
...
# Copy to clipboard
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py 10.1038/nature12345 --clipboard
```
...
python .cursor/skills/citation-management/scripts/search_google_scholar.py "transformer neural networks" \
  --year-start 2017 \
  --limit 50 \
  --output transformers_gs.json

python .cursor/skills/citation-management/scripts/search_pubmed.py "deep learning medical imaging" \
  --date-start 2020 \
  --limit 50 \
...
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py 10.1038/s41586-021-03819-2 >> specific.bib
python .cursor/skills/citation-management/scripts/doi_to_bibtex.py 10.1126/science.aam9317 >> specific.bib

# Step 4: Combine all BibTeX files
cat transformers.bib medical.bib specific.bib > combined.bib

# Step 5: Format and deduplicate
python .cursor/skills/citation-management/scripts/format_bibtex.py combined.bib \
  --deduplicate \
  --sort year \
  --descending \
...
# Step 6: Validate
python .cursor/skills/citation-management/scripts/validate_citations.py formatted.bib \
  --auto-fix \
  --report validation.json \
  --output final_references.bib
...
# Validate the result
python .cursor/skills/citation-management/scripts/validate_citations.py references.bib --verbose
```
...
python .cursor/skills/citation-management/scripts/format_bibtex.py messy_references.bib \
  --output step1_formatted.bib

# Step 2: Remove duplicates
python .cursor/skills/citation-management/scripts/format_bibtex.py step1_formatted.bib \
  --deduplicate \
  --output step2_deduplicated.bib

# Step 3: Validate and auto-fix
python .cursor/skills/citation-management/scripts/validate_citations.py step2_deduplicated.bib \
  --auto-fix \
  --output step3_validated.bib

# Step 4: Sort by year
python .cursor/skills/citation-management/scripts/format_bibtex.py step3_validated.bib \
  --sort year \
  --descending \
  --output clean_references.bib

# Step 5: Final validation report
python .cursor/skills/citation-management/scripts/validate_citations.py clean_references.bib \
...
python .cursor/skills/citation-management/scripts/search_google_scholar.py "AlphaFold protein structure" \
  --year-start 2020 \
  --year-end 2024 \
  --sort-by citations \
  --limit 20 \
