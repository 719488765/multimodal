...
```bash
python .cursor/skills/literature-review/scripts/generate_schematic.py "your diagram description" -o figures/output.png
```
...
1. **Verify All DOIs**:
   ```bash
   python .cursor/skills/literature-review/scripts/verify_citations.py my_literature_review.md
   ```
...
1. **Generate PDF**:
   ```bash
   python .cursor/skills/literature-review/scripts/generate_pdf.py my_literature_review.md \
     --citation-style apa \
...
python .cursor/skills/literature-review/scripts/search_databases.py combined_results.json \
  --deduplicate \
  --rank citations \
  --year-start 2015 \
  --year-end 2024 \
...
python .cursor/skills/literature-review/scripts/verify_citations.py crispr_sickle_cell_review.md
...
python .cursor/skills/literature-review/scripts/generate_pdf.py crispr_sickle_cell_review.md \
...
Check dependencies:
```bash
python .cursor/skills/literature-review/scripts/generate_pdf.py --check-deps
```
