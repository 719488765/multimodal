...
python .cursor/skills/research-lookup/scripts/research_lookup.py "your query" --force-model pro

# Force Sonar Reasoning Pro
python .cursor/skills/research-lookup/scripts/research_lookup.py "your query" --force-model reasoning

# Automatic (no flag)
python .cursor/skills/research-lookup/scripts/research_lookup.py "your query"
```
